...
module.exports = {
  ...
  theme: { 
    ...
    extend: {      backgroundImage: {
      ...
      'restaurant-bg':"url(https://cdn.getir.com/getirweb-images/common/partners-background.jpg)",
      'pricebar-bg':"url(https://cdn.getir.com/getirweb-images/common/static-map.png)",
      ...
      'getir-campaigns':"url(data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMTYiIGhl…5ODY1SDguNDg2MTFaIiBmaWxsPSJ3aGl0ZSIvPgo8L3N2Zz4K)",
