...
export default function Footer() {
  ...
  return (
    <div className="bg-white  pt-5">
      <div className='container mx-auto'>
          <div className=' grid grid-cols-4 ml-20 -pt-5'>
            <section>
              ...
              <h6 className=' text-md text-secondary-brand-color'>Getir'i İndirin</h6>
      ...
      <div className='flex items-center justify-between border-t border-gray-200 mt-6 pt-2'>
          <div className=' container -ml-4 text-xs  py-6'>© 2022 Getir  |  
