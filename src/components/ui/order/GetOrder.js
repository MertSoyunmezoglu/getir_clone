...
export default function GetOrder({ totalCartAmount, totalPrice }) {
  ...
  return (
    <div className="h-12 w-auto">
      <button className=" grid lg:grid-cols-6 md:grid-cols-5 sm:grid-cols-3 mb-4 w-full hover:bg-secondary-brand-color items-center text-center     bg-primary-brand-color rounded-lg  ">
