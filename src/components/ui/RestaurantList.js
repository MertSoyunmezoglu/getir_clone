              ...
              <div className="w-full sm:h-40 h-60 rounded-lg bg-white md:flex relative items-center overflow-hidden my-4  sm:px-4">
                <button className="gap-y-10 w-full  md:w-auto sm:flex">
                  <img
                    ...
                    alt="Kampanyalar"
                    className="rounded-lg w-full md:w-auto h-44   sm:h-28"
                  />
                  <span className="   absolute  md:left-48 right-4 top-0 md:top-6 z-[20] flex items-center">
                    <AiOutlineHeart
                  ...
                  <div className="relative w-10 gap-x-1 text-xs rounded-sm h-4    sm:absolute left-6 bottom-10 z-[20] flex items-center">
                    <img
                ...
                <div className=" sm:justify-between ">
                  <div className=" sm:top-8 border relative bottom-2 ml-6 sm:right-6  w-20 gap-x-1 rounded-sm  shadow-md text-primary-brand-color text-xs   h-5 bg-white font-bold  sm:absolute right-4  z-[20] flex items-center">
