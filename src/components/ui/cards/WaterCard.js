...
export default function WaterCard({
  card: { imageWater, index, titleWater, descriptionWater },
}) {
  return (
    <div
      key={index}
    ...
    >
      ...
      <h6 className=" text-lg font-semibold text-primary-brand-color">
        {titleWater}
        <p className=" text-sm font-medium mx-2 text-gray-500">
          {descriptionWater}
        </p>
      </h6>
    </div>
