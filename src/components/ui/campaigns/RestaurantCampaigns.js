...
export default function RestaurantCampaigns({
  restaurant: { id, restaurantimg, title, rate },
}) {
  return (
    <div key={id} className="  bg-white py-8 px-3 rounded-lg ">
      <div className="  w-full flex relative mx-auto items-center h-auto overflow-hidden">
        <button className="gap-y-10 flex-col hidden sm:flex">
          ...
          <div className="relative w-10 gap-x-1 text-primary-brand-color text-xs rounded-sm h-4 bg-white font-bold sm:absolute right-4 bottom-2  z-[40] flex items-center">
            <AiTwotoneStar className="  ml-1 " size={12} /> {rate}
          </div>
        </button>
      </div>
      <div className=" flex justify-between mx-3 mt-3">
        <button className=" overflow-hidden text-base font-semibold text-primary-brand-color truncate">
          {title}
        </button>
