...
export default function FoodKitchen({kitchen:{index,imageKitchen,titleKitchen}}) {
  return (
    ...
    <img src={imageKitchen} className="rounded-lg  w-36 h-20 px-2 "/>
    <h2  className="border-t border-gray-100 pt-2 pb-4 w-full text-xs font-semibold text-primary-brand-color">{titleKitchen}</h2>
    </a>
    </div>
  )
}
