  ...
  return (
    <>
      <div className=" flex   bg-white  h-20  sm:flex-row sm:pl-12 items-center  ">
        ...
        <div className="overflow-hidden before:w-auto before:h-20 before:mt-[88px] sm:before:mt-[120px] before:z-10 before:bg-gradient-to-r before:ml-96 before:from-white before:to-transparent before:absolute before:inset-0"></div>
      </div>
    </>
  );
}
