      ...
      {options.map((option) =>
        click ? (
          <NavLink to={option.to} tabindex="5" role="menuitem">
            <button className=" py-3   flex justify-between w-full px-4  leading-5 hover:bg-purple-50 hover:text-secondary-brand-color text-left">
              {option.name}
            </button>
          </NavLink>
        ) : (
          <NavLink to={option.to} tabindex="5" role="menuitem">
            <span className=" mx-5 flex flex-col md:flex-row items-center justify-start xs:justify-center    border-t border-gray-200">
              <button className=" py-4   flex justify-between w-full   leading-5   hover:text-primary-brand-color text-left">
                {option.name}
              </button>
            </span>
          </NavLink>
