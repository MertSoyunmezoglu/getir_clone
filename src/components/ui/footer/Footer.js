      ...
      <div className="container mx-auto">
        ...
        <div className="flex flex-col md:flex-row items-center justify-start xs:justify-center   border-t border-gray-200 mt-6 pt-2">
          <div className=" container  md:-ml-16 xl:-ml-24  text-md  py-6  flex  ">
            © 2022 Getir
            <span className="relative before:w-1 ml-5 before:h-1   before:rounded-3xl before:bg-primary-brand-color before:absolute before:-left-3 before:top-1/2 before:-translate-y-1/2 "></span>
            <a
